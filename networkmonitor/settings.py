...
MIDDLEWARE = [
    ...
    "networkmonitor.middleware.RequestIdMiddleware",
...
LOGGING = {
    ...
    "filters": {
        "request_id": {
            "()": "networkmonitor.logging_filters.RequestIdFilter",
        },
    },
    "handlers": {
        "console": {
...
REST_FRAMEWORK = {
    ...
    "EXCEPTION_HANDLER": "networkmonitor.exception_handler.exception_handler",
}
