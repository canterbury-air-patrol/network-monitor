...
urlpatterns = [
    ...
    re_path(
        r"^nodes/(?P<node_id>\d+)/snapshots/latest/routes/list/$",
        views.node_latest_routes,
        name="node_latest_routes",
    ),
    re_path(
        r"^nodes/(?P<node_id>\d+)/snapshots/latest/wireless/list/$",
        views.node_latest_wireless,
        name="node_latest_wireless",
    ),
    re_path(
        r"^nodes/(?P<node_id>\d+)/snapshots/(?P<snapshot_id>\d+)/routes/list/$",
        views.node_routes,
        name="node_routes",
    ),
    re_path(
        r"^nodes/(?P<node_id>\d+)/snapshots/(?P<snapshot_id>\d+)/wireless/list/$",
        views.node_wireless,
        name="node_wireless",
    ),
    re_path(
        r"^nodes/(?P<node_id>\d+)/wireless/neighbours/opinion/list/$",
        views.node_get_neighbour_views,
        name="node_get_wireless_views",
    ),
]
